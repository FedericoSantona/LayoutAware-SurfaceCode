...
NOTE: These tests are disabled as prune_dem_to_live_detectors has been removed
along with all DEM hardening functionality.
"""
...
def _disabled_test_prune_drops_detectors_without_errors():
    # Test disabled - prune_dem_to_live_detectors removed
    pass
    # dem = build_dem(
    #     """
    #     detector D0
...
def _disabled_test_prune_keeps_detectors_with_singleton_errors():
    # Test disabled - prune_dem_to_live_detectors removed
    pass
    # dem = build_dem(
    #     """
...
def _disabled_test_prune_respects_metadata_mapping():
    # Test disabled - prune_dem_to_live_detectors removed
    pass
    # dem = build_dem(
    #     """
